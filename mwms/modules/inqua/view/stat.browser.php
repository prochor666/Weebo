<?php
$s = new AdvStats;
$id_inquiry = array_key_exists('id_inquiry', $_GET) ? $_GET['id_inquiry']: 0;
...
<div id="adv-plot-wrapper">
	...
	<div id="inqua-stat-impress"></div>
	<button id="image1" title="<?php echo $s->lng['inqua_stat_as_image']; ?>"><?php echo $s->lng['inqua_stat_as_image']; ?></button>
...
$(document).ready(function()
{
	...
	var exportFilenameURL = weebo.settings.AjaxCall + 'require&file=/mwms/modules/inqua/view/stat.download.php&sfile='+'<?php echo $jsData['export_filename']; ?>';
	...
	/* impress stat */
	var plot1 = $.jqplot('inqua-stat-impress', [s1], {
	...
	$('#image1').on('click', function(){
		AdvAdmin.statImage( jqplotToImg($('#inqua-stat-impress')), mainLabel);
	}).button({
		icons : {
